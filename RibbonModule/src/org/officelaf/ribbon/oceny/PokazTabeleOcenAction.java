    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (top.isOpened() || (maintop != null && maintop_value != null) || (grouptop != null && grouptop_value_g != null) || (presencetop != null)) {
            ...
            for (TopComponent tc : WindowManager.getDefault().getOpenedTopComponents(mode)) {
                if (tc instanceof NotesTableTopComponent) {
                    if (((NotesTableTopComponent) tc).getGrupaCwiczeniowa().getId() == grupa.getId()) {
                        if (!tc.isOpened()) {
                            tc.open();
                        }
                        tc.requestActive();
            ...
            NotesTableTopComponent notestop = new NotesTableTopComponent();
